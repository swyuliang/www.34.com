...
<div class="form-div">
    <form action="" name="searchForm">
       ...
       商品名称：<input type="text" name="goods_name" value="<?php echo I('get.goods_name'); ?>" /><br/>
        ...
        商品价格：<input type="text" size="10" name="start_price" value="<?php echo I('get.start_price'); ?>" />-<input type="text" size="10" name="end_price" value="<?php echo I('get.end_price'); ?>" /><br/>

        添加时间：<input type="text" size="10" id="start_addtime" name="start_addtime" value="<?php echo I('get.start_addtime'); ?>" />-<input type="text" size="10" id="end_addtime" name="end_addtime" value="<?php echo I('get.end_addtime'); ?>" /><br />
